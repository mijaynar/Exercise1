...
//    I am done!
    private static void printInfo() {
        ...
        System.out.println("My name is Jay Mistry");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- Work so hard that you can achieve anything that you dreamt of!");
        System.out.println("-- Enjoy the semester with little bit of fun");
	System.out.println();	

        System.out.println("My hobbies:");
        System.out.println("-- Dancing");
        System.out.println("-- Watching movies in theatres");
        System.out.println("-- Reading/Watching TV");
        System.out.println("-- Roaming all around the world");
